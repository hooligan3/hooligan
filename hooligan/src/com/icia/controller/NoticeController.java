...
public class NoticeController {
	//공지사항 조회
	@RequestMapping(value="/main/notice/list", method="GET")
	...
	//공지사항 관리자 페이지 조회
	@RequestMapping(value="/admin/notice/list", method="GET")
	...
	//공지사항 작성 폼으로
		@RequestMapping(value="/admin/notice/register",method="GET")
		...
		//공지사항 작성
		@RequestMapping(value="/admin/notice/register",method="POST")
		...
		//공지사항 뷰
		@RequestMapping(value="/main/notice/view", method="GET")
		...
		//공지사항 어드민 뷰
				@RequestMapping(value="/admin/notice/view", method="GET")
	...
	//공지사항 수정POST
		...
		public static ModelAndView updateEnd(HttpServletRequest req) {
			...
			mav.setView("/hooligan/admin/notice/list");
			mav.setRedirect();
			return mav;
		}
		//공지사항 삭제
		@RequestMapping(value="/admin/notice/delete", method="POST")
