...
public class ProductFilter implements Filter {
    ...
    public ProductFilter() {
    	whiteList.add("/hooligan/product/productMain");
    	whiteList.add("/hooligan/product/evaluationList");
    	whiteList.add("/hooligan/product/productBrand");
    	whiteList.add("/hooligan/product/clothesSort");
    	whiteList.add("/hooligan/product/handmade");
    	whiteList.add("/hooligan/product/food");
